...
import addRingSideView from './addRingSideView';

const addUranusLikePlanet = (canvas, context, speedIndicator, distanceFromSun, width, planetColor, ringWidth, distanceRingFromPlanet, ringColor) => {
    ...
    addRingSideView(canvas, context, width, ringWidth, distanceRingFromPlanet, ringColor);
    ...
    drawFilledArc (canvas, context, 0, 0, width, planetColor) 
...
export default addUranusLikePlanet;